                        ...
                        <div>
                            ...
                            {userType==="Admin"?<div className="form-row input-box-1">
                                <div className="col-lg-7">
                                    <input type="password" name="secretKey"  onChange={(e)=>{setsecretKey(e.target.value)}} placeholder="SecretKey" className="form-control my-3 p-2" autoComplete="off" required/>
                                </div>
                            </div>: null}
                            ...
                            <p>Already have an account? <a href=""><Link to='/'>Log in</Link></a></p>
                       </form>
                        </div>
                    </div>
                </div>
